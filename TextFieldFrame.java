...
public class TextFieldFrame extends JFrame {
    ...
    private final JTextField textField2; // campo de texto contruído com texto
    ...
    public TextFieldFrame() {
        ...
        textField2 = new JTextField("Digite aqui"); // A largura de um JTextField ~e baseada no texto padrão a menos que o gerenciador de layout sobrescreva esse tamanho
        add(textField2); // adiciona textField2 ao JFrame
        
        // contrói textfield com o texto padrão e 21 colunas
        textField3 = new JTextField("TEXTO FIXO"); // largura baseada no segundo argumento a menos que o gerenciador de layourt sobrescreva esse tamanho
        ...
        passwordField = new JPasswordField(10); // o testo nesse componente será oculto por asteriscos por padrão
